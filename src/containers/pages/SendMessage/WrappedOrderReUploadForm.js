...
class QueryForm extends React.Component {
    ...
    fetchOrderLog = (data) => {
        ...
        myAxios.post('/saas/support/order/orderReUpload', reqParams).then((json) => {
            if (json.code === '000') {
                this.setState({
                    loading: false,
                })
...
const WrappedOrderReUploadForm = Form.create()(QueryForm);

export default  WrappedOrderReUploadForm;